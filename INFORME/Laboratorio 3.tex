...
\pagebreak
\subsection{Resultados para los individuos}
...
\subsubsection{Nube de individuos}
\begin{figure}[h]
  \centering
...
\subsubsection{Cosenos cuadrados}
\begin{center}
\begin{tabular}{|c|c|c|}
\hline
 & Dim.1  &     Dim.2 \\
...
\pagebreak
\subsection{Resultados para las variables}
...
\end{tabular}
\end{center}
\subsubsection{Nube de variables}
\begin{figure}[h]
  \centering
